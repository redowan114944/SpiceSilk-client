                ...
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        ...
                        <img className="w-11" src="https://i.ibb.co/Q66MjFM/kisspng-catering-food-computer-icons-logo-event-management-catering-5abf487cd18447-75462904152248537.png" alt="" />
                            <span className="self-center text-2xl font-semibold">Sp<span className="text-yellow-500">i</span>ce S<span className="text-yellow-500">i</span>lk</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 text-sm gap-x-8 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        <div className="space-y-2">
                            <h3 className="tracking-wide uppercase text-gray-100">Contact Us</h3>
                            <ul className="space-y-1">
                                <li>
                                    <p>GuaPanchak, Anowara, Chattogram, Bangladesh</p>
                                </li>
                                <li>
                                    <p>01787860270</p>
                                </li>
                        ...
                        <div className="space-y-2">
                            <h3 className="uppercase text-gray-100">Follow Us</h3>
